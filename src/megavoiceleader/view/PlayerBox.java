...
import megavoiceleader.InputParameters;
import megavoiceleader.MidiOut;
import megavoiceleader.PatternQueueStorerSaver;
...
public class PlayerBox {
    ...
    private void nowshow (String message, String title, Stage stage) {
        ...
        if (!megavoiceleader.InputParameters.get_q_mode()) pattern_to_play  = megavoiceleader.PatternStorerSaver1.get_pattern();
    ...
    public class LauncherThread {
        ...
        //                                if(pps_player.isStarted()) System.out.println("Player is started");
                            ...
                            while (queue_index < PatternQueueStorerSaver.get_queue_size()) {
                                if (megavoiceleader.InputParameters.get_out_to_midi_yoke()) midiInitialize();
                                else usedefault = true;
                                if (usedefault) pps_player = new Player();
